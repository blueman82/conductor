...
**Current**: v3.4.3 - CompareBatch: Pattern similarity now uses batched Claude calls (N→1 agent spawns per task check). Includes LOC reduction from v3.4.2 (ClaudeService, graceful degradation, BaseSelector).
